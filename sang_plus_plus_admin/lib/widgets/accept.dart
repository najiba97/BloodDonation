...
class _AcceptState extends State<Accept> {
  ...
  String date, heure = '', erreur = '', dateHeure = '', dateFr = '';
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (myDate != null) {
                                      dateCtl.text =
                                          DateFormat.yMd().format(myDate);
                                      String month =
                                          myDate.month.toString().length == 1
                                              ? '0${myDate.month}'
                                              : myDate.month.toString();
                                      String day =
                                          myDate.day.toString().length == 1
                                              ? '0${myDate.day}'
                                              : myDate.day.toString();
                                      time = '${myDate.year}-$month-$day';
                                      dateFr = '$day/$month/${myDate.year}';
                                    }
                                    setState(() {
                                      date = dateCtl.text;
                                    });
                                ...
                                FloatingActionButton(
                                  ...
                                  onPressed: () async {
                                    if (formKey.currentState.validate() ==
                                      ...
                                      await adminMedcinData.updateNotif(dateFr,
